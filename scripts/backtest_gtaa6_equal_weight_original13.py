"""GTAA AGG 6 Equal-Weight Monthly Rebalancing - Original 13 Assets

Original GTAA 13 universe (no QQQ, no EFA).
Strategy-Tracker Version - Saves results to database.

Uses shared Portfolio class for lot-level tracking with:
...
ETF_UNIVERSE = {
    ...
    'VEA': 'Foreign Developed',
    'VWO': 'Foreign Emerging',
    'VGIT': 'US 10Y Gov Bonds',
    'IGOV': 'Foreign 10Y Gov Bonds',
    'VCIT': 'US Corporate Bonds',
    'VGLT': 'US 30Y Gov Bonds',
    'GSG': 'Commodities',
    'IAU': 'Gold',
    'VNQ': 'Real Estate',
}
...
print("="*100)
print("GTAA AGG 6 EQUAL-WEIGHT - ORIGINAL 13 ASSETS (No QQQ, No EFA)")
print("="*100)
print()
...
# Save results
output_dir = Path('docs/strategy_results/gtaa_agg6_equal_weight_FIXED')
...
summary = {
    'Strategy': 'GTAA AGG 6 Equal-Weight (1998-2026) - FIXED',
...
save_backtest_results(
    strategy_name='gtaa6',
    variant='equal_weight_original13',
    ...
    config={
        ...
        'top_n': TOP_N,
        'description': 'GTAA 6 Equal-Weight Original 13 (no QQQ, no EFA) - monthly rebalancing'
    }
)
