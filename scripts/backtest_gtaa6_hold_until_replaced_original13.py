"""GTAA AGG 6 Hold Until Replaced - Original 13 Assets

Original GTAA 13 universe (no QQQ, no EFA).
Lower turnover version - only rebalances when top 6 assets change.
...
print("="*100)
print("GTAA AGG 6 'HOLD UNTIL REPLACED' - ORIGINAL 13 ASSETS (No QQQ, No EFA)")
print("="*100)
print()
...
save_backtest_results(
    strategy_name='gtaa6',
    variant='hold_until_replaced_original13',
    ...
    config={
        ...
        'top_n': TOP_N,
        'description': 'GTAA 6 Hold Until Replaced Original 13 (no QQQ, no EFA) - only rebalance when signals change'
    }
)
