"""GTAA AGG 6 Equal-Weight Monthly Rebalancing
...
print("="*100)
print("GTAA AGG 6 EQUAL-WEIGHT MONTHLY REBALANCING - FIXED")
print("="*100)
print()
...
save_backtest_results(
    ...
    config={
        ...
        'top_n': TOP_N,
        'description': 'GTAA 6 Equal-Weight with monthly rebalancing (1998-2026)'
    }
)
