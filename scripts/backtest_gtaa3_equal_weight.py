"""GTAA AGG 3 Equal-Weight Monthly Rebalancing

Holds the top 3 assets by momentum (instead of 6).
Uses separate Portfolio objects for pre-tax and after-tax tracking.
...
print("="*100)
print("GTAA AGG 3 EQUAL-WEIGHT MONTHLY REBALANCING")
print("="*100)
print()
...
for i, signal_date in enumerate(month_ends):
    ...
    # NOW rank and take top N from de-duplicated list
    ...
    # Determine target holdings (top N above MA200)
    target_holdings = set()
    ...
    # CRITICAL: We always have TOP_N slots (1/TOP_N each). If an asset is below MA200,
    ...
    slot_weight = 1.0 / TOP_N  # Always 1/TOP_N, regardless of how many qualify
...
# Save results
output_dir = Path('docs/strategy_results/gtaa3_equal_weight')
...
summary = {
    'Strategy': 'GTAA AGG 3 Equal-Weight (1998-2026)',
...
save_backtest_results(
    ...
    config={
        ...
        'top_n': TOP_N,
        'description': 'GTAA 3 Equal-Weight with monthly rebalancing (1998-2026)'
    }
)
