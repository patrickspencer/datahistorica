"""GTAA AGG 3 Hold Until Replaced - Clean Implementation with Full Lot Tracking
...
print("="*100)
print("GTAA AGG 3 'HOLD UNTIL REPLACED' - CLEAN IMPLEMENTATION")
print("="*100)
print()
...
# Save results
output_dir = Path('docs/strategy_results/gtaa3_hold_until_replaced')
...
summary = {
    'Strategy': 'GTAA AGG 3 Hold Until Replaced (1998-2026)',
...
save_backtest_results(
    ...
    config={
        ...
        'top_n': TOP_N,
        'description': 'GTAA 3 Hold Until Replaced - only rebalance when signals change (1998-2026)'
    }
)
