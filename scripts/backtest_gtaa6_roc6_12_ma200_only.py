"""GTAA AGG 6 with 6M/12M ROC Average and 200-Day MA Filter

Modified backtest using:
- Average of 6-month and 12-month ROC only (not 1, 3, 6, 12)
- 200-day MA filter only (no treasury yield filter)
...
print("="*100)
print("GTAA AGG 6 - 6M/12M ROC WITH 200-DAY MA FILTER")
print("="*100)
...
# Save results
output_dir = Path('docs/strategy_results/gtaa6_roc6_12_ma200_only')
...
summary = {
    'Strategy': 'GTAA 6 - ROC6/12 with MA200 Only',
